      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          ...
          <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-3 shadow-md flex flex-col gap-3">
            ...
            <div className="bg-slate-950/80 border border-teal-500/30 rounded-lg p-2.5 flex flex-col gap-1.5">
              <div className="flex items-center justify-between gap-2">
                <label className="text-[10px] font-bold text-teal-300 flex items-center gap-1">
                ...
                <span className="text-xs font-mono font-bold text-teal-400">{activeData.sumOfAnteriors.toFixed(1)} mm</span>
              </div>
              ...
              {!isAutoFromFdi && (
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-20 bg-slate-900 border border-teal-500/40 rounded-md px-2 py-1 text-xs font-bold text-teal-200 focus:outline-none focus:border-teal-400 font-mono text-center"
                  />
                  <input
                    type="range"
                    min="30"
                    ...
                    value={data.sumOfAnteriors}
                    onChange={(e) => handleSumChange(parseFloat(e.target.value))}
                    className="flex-1 accent-teal-500 cursor-pointer h-1"
                  />
                </div>
              )}
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-slate-700 rounded-md px-2 py-1.5 text-[11px] font-mono font-bold text-slate-200 focus:outline-none focus:border-teal-500"
                />
              </div>
              ...
              <div className="flex flex-col gap-1">
                ...
                <select
                  ...
                  className="w-full px-2 py-1.5 bg-slate-950 border border-slate-700 rounded-md text-[11px] font-bold text-slate-200 focus:outline-none focus:border-teal-500 cursor-pointer"
                >
          ...
          {/* CALCULATED SUMMARY METRICS PANEL */}
          <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-3 shadow-md flex flex-col gap-2.5">
            <div className="flex items-center justify-between border-b border-slate-800 pb-2">
              ...
              {isAutoFromFdi ? (
                ...
                <span className="text-[9px] text-amber-400">Enter Tab 6 tooth widths</span>
              )}
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 font-mono text-[11px]">
              <div className="bg-slate-950 border border-slate-800/80 p-2 rounded-lg flex flex-col gap-0.5">
        ...
        <div className="lg:col-span-7 flex flex-col gap-4">
          ...
          <div className="flex-1 bg-slate-900 border border-slate-800 rounded-2xl p-2 shadow-2xl relative min-h-[580px] flex flex-col">
