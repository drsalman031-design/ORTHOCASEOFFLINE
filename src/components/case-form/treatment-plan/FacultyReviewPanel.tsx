          ...
          <div className="space-y-3">
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full text-xs sm:text-sm p-3 rounded-xl border border-slate-300 bg-white focus:ring-2 focus:ring-teal-500 focus:outline-none"
              />
            </div>
      ...
      <div className="bg-amber-50/40 rounded-2xl border border-amber-200 shadow-xs p-4 sm:p-6 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full text-xs sm:text-sm p-3 rounded-xl border border-slate-300 bg-white focus:ring-2 focus:ring-amber-500 focus:outline-none"
          />
        </div>
    ...
    <div className="bg-purple-50/50 rounded-2xl border border-purple-200 shadow-xs p-4 sm:p-6 space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          rows={3}
          className="w-full text-xs sm:text-sm p-3 rounded-xl border border-slate-300 bg-white focus:ring-2 focus:ring-purple-500 focus:outline-none"
        />
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 backdrop-blur-xs p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-5 space-y-4 shadow-2xl border border-slate-200">
            ...
            <textarea
              ...
              rows={3}
              className="w-full text-xs p-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-purple-500 focus:outline-none"
            />
