          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            {onDelete && (
              <button
                ...
                className="touch-target rounded-xl bg-rose-950/60 text-rose-300 hover:bg-rose-900 active:bg-rose-900 active:text-rose-100 flex items-center justify-center cursor-pointer border border-rose-800/50"
                title="Delete Case"
